...
function lex_error(env, loc, err) {
  ...
  var lex_errors_acc = /* :: */{
    _0: lex_errors_acc_000,
    _1: lex_errors_acc_001
  };
...
function unexpected_error(env, loc, value) {
  return lex_error(env, loc, /* UnexpectedToken */{
              tag: 1,
              _0: value
            });
}
...
function unexpected_error_w_suggest(env, loc, value, suggest) {
  return lex_error(env, loc, /* UnexpectedTokenWithSuggestion */{
              tag: 2,
              _0: value,
              _1: suggest
            });
...
function illegal_number(env, lexbuf, word, token) {
  ...
  var env$1 = lex_error(env, loc, /* UnexpectedToken */{
        tag: 1,
        _0: "ILLEGAL"
      });
  return /* tuple */[
...
function save_comment(env, start, _end, buf, multiline) {
  ...
  var lex_comments_acc = /* :: */{
    _0: lex_comments_acc_000,
    _1: lex_comments_acc_001
  };
  var init = env.lex_state;
  return {
          lex_source: env.lex_source,
...
function token(env, lexbuf) {
  ...
  while(true) {
    ...
    switch (__ocaml_lex_state$1) {
      ...
      case 1 :
          var env$1 = lex_error(env, from_lb(env.lex_source, lexbuf), /* UnexpectedToken */{
                tag: 1,
                _0: "ILLEGAL"
              });
      ...
      case 4 :
          var sp = Lexing.sub_lexeme(lexbuf, lexbuf.lex_start_pos + 2 | 0, Caml_array.caml_array_get(lexbuf.lex_mem, 0));
          var escape_type = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), lexbuf.lex_curr_pos);
      ...
      case 10 :
          var w = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), lexbuf.lex_curr_pos);
          return illegal_number(env, lexbuf, w, /* T_NUMBER */{
                      tag: 0,
                      _0: /* BINARY */0
                    });
      case 11 :
      ...
      case 12 :
          var w$1 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), lexbuf.lex_curr_pos);
          return illegal_number(env, lexbuf, w$1, /* T_NUMBER */{
                      tag: 0,
                      _0: /* OCTAL */2
                    });
      case 13 :
      ...
      case 14 :
          var w$2 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), lexbuf.lex_curr_pos);
          return illegal_number(env, lexbuf, w$2, /* T_NUMBER */{
                      tag: 0,
                      _0: /* LEGACY_OCTAL */1
                    });
      case 15 :
      ...
      case 77 :
          var env$9 = lex_error(env, from_lb(env.lex_source, lexbuf), /* UnexpectedToken */{
                tag: 1,
                _0: "ILLEGAL"
              });
          return /* tuple */[
    ...
    var w$3 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), lexbuf.lex_curr_pos);
    return illegal_number(env, lexbuf, w$3, /* T_NUMBER */{
                tag: 0,
                _0: /* NORMAL */3
              });
  };
...
function __ocaml_lex_template_tail_rec(_env, lexbuf, ___ocaml_lex_state) {
  while(true) {
    ...
    switch (__ocaml_lex_state$1) {
      ...
      case 5 :
          var env$3 = lex_error(env, from_lb(env.lex_source, lexbuf), /* UnexpectedToken */{
                tag: 1,
                _0: "ILLEGAL"
              });
          return /* tuple */[
...
function type_token(env, lexbuf) {
  ...
  while(true) {
    ...
    switch (__ocaml_lex_state$1) {
      ...
      case 7 :
          var neg = Lexing.sub_lexeme(lexbuf, lexbuf.lex_start_pos, Caml_array.caml_array_get(lexbuf.lex_mem, 0));
          var num = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), Caml_array.caml_array_get(lexbuf.lex_mem, 1));
          var w = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 1), lexbuf.lex_curr_pos);
          return illegal_number(env, lexbuf, w, mk_num_singleton(/* BINARY */0, num, neg));
      case 8 :
          var neg$1 = Lexing.sub_lexeme(lexbuf, lexbuf.lex_start_pos, Caml_array.caml_array_get(lexbuf.lex_mem, 0));
          var num$1 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), lexbuf.lex_curr_pos);
          return /* tuple */[
                  env,
                  mk_num_singleton(/* BINARY */0, num$1, neg$1)
                ];
      case 9 :
          var neg$2 = Lexing.sub_lexeme(lexbuf, lexbuf.lex_start_pos, Caml_array.caml_array_get(lexbuf.lex_mem, 0));
          var num$2 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), Caml_array.caml_array_get(lexbuf.lex_mem, 1));
          var w$1 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 1), lexbuf.lex_curr_pos);
          return illegal_number(env, lexbuf, w$1, mk_num_singleton(/* OCTAL */2, num$2, neg$2));
      case 10 :
          var neg$3 = Lexing.sub_lexeme(lexbuf, lexbuf.lex_start_pos, Caml_array.caml_array_get(lexbuf.lex_mem, 0));
          var num$3 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), lexbuf.lex_curr_pos);
          return /* tuple */[
                  env,
                  mk_num_singleton(/* OCTAL */2, num$3, neg$3)
                ];
      case 11 :
          var neg$4 = Lexing.sub_lexeme(lexbuf, lexbuf.lex_start_pos, Caml_array.caml_array_get(lexbuf.lex_mem, 0));
          var num$4 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), Caml_array.caml_array_get(lexbuf.lex_mem, 1));
          var w$2 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 1), lexbuf.lex_curr_pos);
          return illegal_number(env, lexbuf, w$2, mk_num_singleton(/* LEGACY_OCTAL */1, num$4, neg$4));
      case 12 :
          var neg$5 = Lexing.sub_lexeme(lexbuf, lexbuf.lex_start_pos, Caml_array.caml_array_get(lexbuf.lex_mem, 0));
          var num$5 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), lexbuf.lex_curr_pos);
          return /* tuple */[
                  env,
                  mk_num_singleton(/* LEGACY_OCTAL */1, num$5, neg$5)
                ];
      case 13 :
          var neg$6 = Lexing.sub_lexeme(lexbuf, lexbuf.lex_start_pos, Caml_array.caml_array_get(lexbuf.lex_mem, 0));
          var num$6 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), Caml_array.caml_array_get(lexbuf.lex_mem, 1));
          var w$3 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 1), lexbuf.lex_curr_pos);
          var match$4;
          try {
            match$4 = /* tuple */[
              env,
      ...
      case 14 :
          var neg$7 = Lexing.sub_lexeme(lexbuf, lexbuf.lex_start_pos, Caml_array.caml_array_get(lexbuf.lex_mem, 0));
          var num$7 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), lexbuf.lex_curr_pos);
          try {
            return /* tuple */[
                    env,
      ...
      case 15 :
          var neg$8 = Lexing.sub_lexeme(lexbuf, lexbuf.lex_start_pos, Caml_array.caml_array_get(lexbuf.lex_mem, 0));
          var num$8 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), Caml_array.caml_array_get(lexbuf.lex_mem, 1));
          var w$4 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 1), lexbuf.lex_curr_pos);
          return illegal_number(env, lexbuf, w$4, mk_num_singleton(/* NORMAL */3, num$8, neg$8));
      case 16 :
          var neg$9 = Lexing.sub_lexeme(lexbuf, lexbuf.lex_start_pos, Caml_array.caml_array_get(lexbuf.lex_mem, 0));
          var num$9 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), lexbuf.lex_curr_pos);
          return /* tuple */[
                  env,
                  mk_num_singleton(/* NORMAL */3, num$9, neg$9)
                ];
      case 17 :
          var neg$10 = Lexing.sub_lexeme(lexbuf, lexbuf.lex_start_pos, Caml_array.caml_array_get(lexbuf.lex_mem, 0));
          var num$10 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 0), Caml_array.caml_array_get(lexbuf.lex_mem, 1));
          var w$5 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 1), lexbuf.lex_curr_pos);
          return illegal_number(env, lexbuf, w$5, mk_num_singleton(/* NORMAL */3, num$10, neg$10));
      case 18 :
          var neg$11 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 1), Caml_array.caml_array_get(lexbuf.lex_mem, 0));
          var num$11 = Lexing.sub_lexeme(lexbuf, Caml_array.caml_array_get(lexbuf.lex_mem, 3), Caml_array.caml_array_get(lexbuf.lex_mem, 2));
          return /* tuple */[
                  env,
  ...
  while(true) {
    ...
    switch (__ocaml_lex_state$1) {
      ...
      case 14 :
          ...
          var env$1 = code$6 > 1114111 ? lex_error(env, from_lb(env.lex_source, lexbuf), /* UnexpectedToken */{
                  tag: 1,
                  _0: "ILLEGAL"
                }) : env;
          List.iter((function (param) {
      ...
      case 15 :
          ...
          var env$2 = lex_error(env, from_lb(env.lex_source, lexbuf), /* UnexpectedToken */{
                tag: 1,
                _0: "ILLEGAL"
              });
...
function __ocaml_lex_regexp_rec(_env, lexbuf, ___ocaml_lex_state) {
  while(true) {
    ...
    switch (__ocaml_lex_state$1) {
      ...
      case 6 :
          var env$4 = lex_error(env, from_lb(env.lex_source, lexbuf), /* UnexpectedToken */{
                tag: 1,
                _0: "ILLEGAL"
              });
          return /* tuple */[
...
function lookahead(iOpt, env) {
  ...
  lex_until(t, i);
  var match = Caml_array.caml_array_get(t.la_results, i);
  if (match !== undefined) {
    return match[1];
  }
  throw {
...
function with_loc(fn, env) {
  ...
  var end_loc = loc !== undefined ? loc : (error$1(env, /* Assertion */{
            tag: 0,
  ...
  if (typeof token$5 === "number") {
    ...
    switch (token$5.tag | 0) {
      ...
      case /* T_NUMBER_SINGLETON_TYPE */5 :
          ...
          token$4(env, /* T_NUMBER_SINGLETON_TYPE */{
                tag: 5,
                _0: number_type,
                _1: value$1
              });
  ...
  while(true) {
    ...
    if (typeof match === "number" && match === 42) {
      ...
      return function finish_fn$prime(callee, args) {
        var match = args !== undefined ? /* tuple */[
            args[0],
            args[1]
          ] : /* tuple */[
            callee[0],
  ...
  if (typeof number_type === "number") {
    switch (number_type) {
      ...
      case /* T_DIV */96 :
          ...
          if (flags !== raw_flags) {
            error$1(env, /* InvalidRegExpFlags */{
                  tag: 3,
                  _0: raw_flags
                });
          }
...
function declare_export_declaration(allow_export_typeOpt, env) {
    ...
    if (match >= 52) {
      if (match !== 59) {
        if (match !== 97) {
          ...
          var specifiers = /* ExportBatchSpecifier */{
            tag: 1,
            _0: loc,
            _1: local_name
          };
  ...
  switch (exit) {
    case 1 :
        ...
        var specifiers$1 = /* ExportSpecifiers */{
          tag: 0,
          _0: match$6[0]
        };
    ...
    if (match >= 22) {
      ...
      if (match === 0 && Curry._2(Parser_env_Peek.value, 1, env) === "module") {
        ...
        if (in_module || Curry._2(Parser_env_Peek.token, undefined, env) === /* T_PERIOD */9) {
          ...
          var kind = module_kind !== undefined ? module_kind : /* CommonJS */({
                tag: 0,
                _0: loc$3
              });
          return /* tuple */[
    ...
    switch (expr.tag | 0) {
      case /* Array */0 :
          ...
          var elements = List.map((function (param) {
                  ...
                  return /* Element */{
                          tag: 0,
                          _0: Curry._2(Parse.pattern_from_expr, env, /* tuple */[
                                match$1[0],
                                match$1[1]
                              ])
                        };
  ...
  while(true) {
    ...
    if (typeof match === "number") {
      if (match >= 91) {
        ...
        var attribute$1 = /* SpreadAttribute */{
          tag: 1,
...
function normalize(name) {
  switch (name.tag | 0) {
    ...
    case /* MemberExpression */2 :
        ...
        var _object$1;
        _object$1 = _object.tag ? normalize(/* MemberExpression */{
                tag: 2,
                _0: _object._0
              }) : _object._0[1].name;
...
function element_without_lt(env, start_loc) {
  ...
  if (closingElement !== undefined) {
    ...
    if (normalize(closingElement[1].name) !== opening_name) {
      error$1(env, /* ExpectedJSXClosingTag */{
            tag: 6,
            _0: opening_name
          });
    }
        ...
        var match$10 = typeof match$9 === "number" ? (
            match$9 !== 44 ? (
                match$9 !== 59 ? /* tuple */[
                    /* ImportValue */2,
                    undefined
                  ] : (!env$2.parse_options.types ? error$1(env$2, /* UnexpectedTypeImport */8) : undefined, /* tuple */[
                      /* ImportType */0,
                      Curry._2(Parse.identifier, undefined, env$2)
                    ])
              ) : (!env$2.parse_options.types ? error$1(env$2, /* UnexpectedTypeImport */8) : undefined, token$4(env$2, /* T_TYPEOF */44), /* tuple */[
                  /* ImportTypeof */1,
                  undefined
                ])
          ) : /* tuple */[
          ...
          switch (match) {
            ...
            case /* T_TRY */21 :
                ...
                var end_loc$3 = finalizer !== undefined ? finalizer[0] : (
                    handler !== undefined ? handler[0] : (error_at(env, /* tuple */[
                              block[0],
                              /* NoCatchOrFinally */20
                            ]), block[0])
                  );
            ...
            case /* T_FOR */37 :
                ...
                if (typeof match$9 === "number") {
                  if (match$9 !== 15) {
                    ...
                    var left$1;
                    if (init !== undefined) {
                      left$1 = init.tag ? /* LeftExpression */({
                            tag: 1,
                            _0: init._0
                          }) : /* LeftDeclaration */({
                            tag: 0,
...
function directives(env, term_fn, item_fn) {
  ...
  List.iter((function (param) {
          ...
          if (typeof token !== "number" && token.tag === /* T_STRING */1) {
            if (token._0[3]) {
              return strict_error_at(env$1, /* tuple */[
                          param[0],
...
function parse(content, options) {
  try {
    ...
    var _type = function (param) {
      ...
      if (typeof t === "number") {
        ...
        switch (t.tag | 0) {
          case /* Nullable */0 :
              var t$1 = t._0;
              return node("NullableTypeAnnotation", loc, [/* tuple */[
                            "typeAnnotation",
                            _type(t$1)
                          ]]);
          case /* Function */1 :
          ...
          case /* Array */3 :
              var t$2 = t._0;
              return node("ArrayTypeAnnotation", loc, [/* tuple */[
                            "elementType",
                            _type(t$2)
                          ]]);
          case /* Generic */4 :
    ...
    var export_specifiers = function (param) {
      if (param !== undefined) {
        if (param.tag) {
          return array([node("ExportBatchSpecifier", param._0, [/* tuple */[
                              "name",
    ...
    var statement = function (param) {
      ...
      switch (b.tag | 0) {
        ...
        case /* ClassDeclaration */20 :
            ...
            var c = param$1[1];
            var id$1 = c.id;
            var match$1 = id$1 !== undefined ? /* tuple */[
                "ClassDeclaration",
                identifier(id$1)
              ] : /* tuple */[
                "ClassExpression",
            ...
            var specifiers = List.map((function (id) {
                    switch (id.tag | 0) {
                      ...
                      case /* ImportDefaultSpecifier */1 :
                          var id$1 = id._0;
                          return node("ImportDefaultSpecifier", id$1[0], [/* tuple */[
                                        "id",
                                        identifier(id$1)
                                      ]]);
                      case /* ImportNamespaceSpecifier */2 :
                          var param = id._0;
                          return node("ImportNamespaceSpecifier", param[0], [/* tuple */[
                                        "id",
                                        identifier(param[1])
                                      ]]);
    ...
    var jsx_opening_attribute = function (attribute) {
      if (attribute.tag) {
        ...
        return node("JSXSpreadAttribute", param[0], [/* tuple */[
                      "argument",
