...
var yyact = [
  ...
  (function (__caml_parser_env) {
      return /* Message_map_field */{
              tag: 1,
              _0: Parsing.peek_val(__caml_parser_env, 0)
            };
    }),
  (function (__caml_parser_env) {
      return /* Message_oneof_field */{
              tag: 2,
              _0: Parsing.peek_val(__caml_parser_env, 0)
            };
    }),
  ...
  (function (__caml_parser_env) {
      return /* Extension_single_number */{
              tag: 0,
              _0: Parsing.peek_val(__caml_parser_env, 0)
            };
    }),
  ...
  (function (__caml_parser_env) {
      ...
      throw {
            RE_EXN_ID: Compilation_error,
            _1: /* Missing_semicolon_for_enum_value */{
              tag: 9,
              _0: enum_value,
              _1: loc
            },
                        ...
                        List.iter((function (record_field) {
                                ...
                                switch (rf_field_type.tag | 0) {
                                  ...
                                  case /* Rft_associative_field */3 :
                                      ...
                                      var pp_key = gen_pp_field(/* Ft_basic_type */{
                                            tag: 0,
                                            _0: match$1[2][0]
                                          });
...
function compile_enum_p1(file_name, file_options, scope, param) {
  ...
  return type_of_spec(file_name, file_options, param.enum_id, scope, /* Enum */{
              tag: 0,
              _0: {
...
function compile_message_p1(file_name, file_options, message_scope, param) {
  ...
  var match = List.fold_left((function (param, f) {
          ...
          switch (f.tag | 0) {
            ...
            case /* Message_oneof_field */2 :
                var field$2 = /* Message_oneof_field */{
                  tag: 1,
  ...
  return Pervasives.$at(match[2], /* :: */{
              _0: type_of_spec(file_name, file_options, param.id, message_scope, /* Message */{
                    tag: 1,
                    _0: {
                      extensions: match[1],
                      message_name: message_name,
  ...
  var message_body = List.fold_left((function (message_body, field) {
          switch (field.tag | 0) {
            ...
            case /* Message_map_field */2 :
                ...
                var resolved_map = /* Message_map_field */{
                  tag: 2,
                  _0: {
                    map_name: map_name,
...
function compile_field_type(field_name, all_types, file_options, field_options, file_name, field_type) {
  ...
  var int32_type = match$1 !== undefined && match$1.tag === /* Constant_litteral */4 && match$1._0 === "int_t" ? /* Ft_basic_type */({
        tag: 0,
        _0: /* Bt_int */2
      }) : /* Ft_basic_type */({
        tag: 0,
  ...
  var int64_type = match$2 !== undefined && match$2.tag === /* Constant_litteral */4 && match$2._0 === "int_t" ? /* Ft_basic_type */({
        tag: 0,
        _0: /* Bt_int */2
      }) : /* Ft_basic_type */({
        tag: 0,
                          ...
                          var match = List.fold_left((function (param, field) {
                                  ...
                                  switch (field.tag | 0) {
                                    case /* Message_field */0 :
                                        ...
                                        if (match$1 !== -132092992) {
                                          if (match$1 >= 202657151) {
                                            record_field_type = /* Rft_required */{
                                              tag: 0,
                                              _0: /* tuple */[
                                                field_type$1,
                                                encoding_number,
                                            ...
                                            record_field_type = /* Rft_repeated_field */{
                                              tag: 2,
                                              _0: /* tuple */[
                                                repeated_type,
                                                field_type$1,
                                          ...
                                          record_field_type = /* Rft_optional */{
                                            tag: 1,
                                            _0: /* tuple */[
                                              field_type$1,
                                              encoding_number,
                                    ...
                                    case /* Message_oneof_field */1 :
                                        ...
                                        var record_field_rf_field_type = /* Rft_variant_field */{
                                          tag: 4,
                                          _0: variant
                                        };
                                        var record_field$1 = {
                                    ...
                                    case /* Message_map_field */2 :
                                        ...
                                        var record_field_type$1 = /* Rft_associative_field */{
                                          tag: 3,
                                          _0: /* tuple */[
                                            associative_type,
                                            mf.map_number,
