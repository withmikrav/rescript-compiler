...
function evolve_enemy(player_dir, typ, spr, obj, context) {
  switch (typ) {
    case /* Goomba */0 :
        ...
        return ;
    case /* GKoopa */1 :
        var match = make$2(undefined, obj.dir, /* SEnemy */{
              tag: 1,
              _0: /* GKoopaShell */3
            }, context, /* tuple */[
              obj.pos.x,
    ...
    case /* RKoopa */2 :
        var match$1 = make$2(undefined, obj.dir, /* SEnemy */{
              tag: 1,
              _0: /* RKoopaShell */4
            }, context, /* tuple */[
              obj.pos.x,
...
function evolve_block(obj, context) {
  dec_health(obj);
  var match = make$2(undefined, undefined, /* SBlock */{
        tag: 3,
        _0: /* QBlockUsed */0
      }, context, /* tuple */[
        obj.pos.x,
...
function check_collisions(collid, all_collids, state) {
  ...
  while(true) {
    ...
    if (equals(collid, h)) {
      ...
      new_objs = dir !== undefined && h._2.id !== c_obj.id ? process_collision(dir, collid, h, state) : /* tuple */[
          undefined,
          undefined
        ];
    }
