...
function cst(ids, s) {
  if (s ? false : true) {
    return mk_expr(ids, /* Alt */{
                tag: 1,
                _0: /* [] */0
              });
  } else {
    return mk_expr(ids, /* Cst */{
                tag: 0,
                _0: s
              });
  }
    ...
    if (typeof s === "number") {
      switch (s) {
        ...
        case /* Beg_of_word */2 :
            ...
            return /* tuple */[
                    seq$1(ids, /* First */332064784, mk_expr(ids, /* After */{
                              tag: 7,
                              _0: c$3
                            }), mk_expr(ids, /* Before */{
                              tag: 6,
        ...
        case /* Not_bound */4 :
            return /* tuple */[
                    alt(ids, /* :: */{
                          _0: seq$1(ids, /* First */332064784, mk_expr(ids, /* After */{
                                    tag: 7,
      ...
      switch (s.tag | 0) {
        ...
        case /* Group */6 :
            ...
            return /* tuple */[
                    seq$1(ids, /* First */332064784, mk_expr(ids, /* Mark */{
                              tag: 4,
                              _0: p
                            }), seq$1(ids, /* First */332064784, match$3[0], mk_expr(ids, /* Mark */{
                                  tag: 4,
                                  _0: p + 1 | 0
                                }))),
                    match$3[1]
        ...
        case /* Pmark */14 :
            ...
            return /* tuple */[
                    seq$1(ids, /* First */332064784, mk_expr(ids, /* Pmark */{
                              tag: 8,
                              _0: s._0
                            }), match$5[0]),
                    match$5[1]
