        ...
        switch (o) {
          ...
          case "*" :
              ...
              if (Caml_obj.caml_equal(t, tokint)) {
                match = Caml_obj.caml_equal(Curry._1(next$1, undefined), /* Op */{
                      tag: 0,
                      _0: "*"
                    }) ? /* tuple */[
                    /* Int */0,
...
function top(_param) {
  while(true) {
    ...
    if (f.tag === /* Sym */3) {
      ...
      while(Caml_obj.caml_notequal(Curry._1(next$1, undefined), /* Op */{
              tag: 0,
              _0: "{"
            })) {
