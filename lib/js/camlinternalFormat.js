  ...
  while(true) {
    ...
    switch (fmtty.tag | 0) {
      ...
      case /* Int */4 :
          ...
          var prec_ty = fmtty_of_precision_fmtty(fmtty._2, /* Int_ty */{
                tag: 2,
                _0: ty_rest
              });
      ...
      case /* Int32 */5 :
          ...
          var prec_ty$1 = fmtty_of_precision_fmtty(fmtty._2, /* Int32_ty */{
                tag: 3,
                _0: ty_rest$1
              });
      ...
      case /* Nativeint */6 :
          ...
          var prec_ty$2 = fmtty_of_precision_fmtty(fmtty._2, /* Nativeint_ty */{
                tag: 4,
                _0: ty_rest$2
              });
      ...
      case /* Int64 */7 :
          ...
          var prec_ty$3 = fmtty_of_precision_fmtty(fmtty._2, /* Int64_ty */{
                tag: 5,
                _0: ty_rest$3
              });
      ...
      case /* Float */8 :
          ...
          var prec_ty$4 = fmtty_of_precision_fmtty(fmtty._2, /* Float_ty */{
                tag: 6,
                _0: ty_rest$4
              });
          return fmtty_of_padding_fmtty(fmtty._1, prec_ty$4);
      case /* Bool */9 :
          return fmtty_of_padding_fmtty(fmtty._0, /* Bool_ty */{
                      tag: 7,
    ...
    return fmtty_of_padding_fmtty(fmtty._0, /* String_ty */{
                tag: 1,
                _0: fmtty_of_fmt(fmtty._1)
              });
  };
    ...
    while(true) {
      ...
      if (match$1 >= 48) {
        if (match$1 < 58) {
          ...
          return parse_after_padding(pct_ind, match$2[0], end_ind, minus$1, plus$1, hash$1, space$1, ign, /* Lit_padding */{
                      tag: 0,
                      _0: padty,
                      _1: match$2[1]
                    });
        ...
        return parse_after_padding(pct_ind, str_ind$1 + 1 | 0, end_ind, minus$1, plus$1, hash$1, space$1, ign, /* Arg_padding */{
                    tag: 1,
                    _0: padty
                  });
      }
      switch (padty) {
        ...
        case /* Right */1 :
            return parse_after_padding(pct_ind, str_ind$1, end_ind, minus$1, plus$1, hash$1, space$1, ign, /* No_padding */0);
        case /* Zeros */2 :
            return parse_after_padding(pct_ind, str_ind$1, end_ind, minus$1, plus$1, hash$1, space$1, ign, /* Lit_padding */{
                        tag: 0,
                        _0: /* Right */1,
                        _1: 0
                      });
              ...
              switch (symb - 108 | 0) {
                ...
                case 2 :
                    ...
                    if (ign_used.contents = true, ign) {
                      ...
                      var ignored$11 = /* Ignored_nativeint */{
                        tag: 4,
                        _0: iconv$2,
                        _1: ignored_001$3
                      };
  ...
  var parse_tag = function (is_open_tag, str_ind, end_ind) {
    try {
      ...
      var formatting = is_open_tag ? /* Open_tag */({
            tag: 0,
            _0: sub_format
          }) : (check_open_box(sub_fmt$1), /* Open_box */{
            tag: 1,
            _0: sub_format
          });
      return /* Fmt_EBB */{
